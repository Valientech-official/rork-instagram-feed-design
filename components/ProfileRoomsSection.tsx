            ...
            >
              <View style={styles.roomContent}>
                <View style={styles.iconContainer}>
                  <DoorOpen
                    size={28}
                    color={room.name === 'コーデQ&A Room' ? '#9ACD32' : room.name === '全身コーデRoom' ? '#FF69B4' : room.name === 'ペアルックRoom' ? '#87CEEB' : room.name === 'シチュエーションRoom' ? '#FFD700' : room.name === 'オススメALL Room' ? '#DDA0DD' : room.name === 'NextトレンドRoom' ? '#D2B48C' : colors.text}
                  />
                </View>
                ...
                <View style={styles.roomInfo}>
                  <View style={styles.postsContainer}>
                    <FileText size={10} color={colors.secondaryText} />
