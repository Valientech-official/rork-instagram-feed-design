...
export const itemCategories: ItemCategory[] = [
  {
    ...
    subCategories: [
      ...
      { id: 'fashion-glasses', name: '伊達メガネ', keywords: ['glasses', 'fashion glasses'] },
      { id: 'sunglasses-2', name: 'サングラス', keywords: ['sunglasses'] },
      { id: 'unique-sunglasses', name: '個性系サングラス', keywords: ['sunglasses', 'unique', 'fashion'] },
      { id: 'funny-sunglasses', name: 'おもしろサングラス', keywords: ['sunglasses', 'novelty', 'funny'] },
      ...
      // 小物その他
      { id: 'other-accessories', name: '小物（その他）', keywords: ['accessories', 'other'] },
      { id: 'necktie', name: 'ネクタイ', keywords: ['necktie', 'tie'] },
      { id: 'scarf', name: 'スカーフ', keywords: ['scarf'] },
      { id: 'bow-tie', name: '蝶ネクタイ', keywords: ['bow tie', 'bowtie'] },
      ...
      { id: 'other-small-items', name: 'その他', keywords: ['accessories', 'other'] },
      ...
      { id: 'other-jewelry', name: 'その他', keywords: ['jewelry', 'accessories', 'other'] },
    ],
  },
  {
    id: 'overalls',
