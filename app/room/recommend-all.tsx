...
export default function RecommendAllRoomScreen() {
  const router = useRouter();
  const insets = useSafeAreaInsets();
  const recommendPosts = roomPosts.filter(post => post.roomName === 'オススメALL Room');
  ...
  React.useEffect(() => {
    ...
    recommendPosts.forEach(post => {
      initialComments[post.id] = [
        { id: '1', username: 'ユーザー1', text: 'とても素敵なコーデですね！参考にさせていただきます✨', avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=100&h=100&fit=crop&crop=face' },
        { id: '2', username: 'ユーザー2', text: 'このスタイル真似したいです！どこのブランドか教えてください', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face' },
        { id: '3', username: 'ユーザー3', text: 'カラーバランスが素晴らしいですね', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face' },
      ];
    });
    ...
    <>
      ...
      <View style={[styles.container, { paddingTop: insets.top }]}>
        <View style={styles.headerContainer}>
          <Text style={styles.title}>オススメALL Room</Text>
          <TouchableOpacity 
...
今日のおすすめコーデです！
トレンドを取り入れつつ、着回しやすいアイテムを選びました✨`}
                      {index === 1 && `

シンプルだけどおしゃれなコーディネート。
どんなシーンにも合わせやすいスタイルです！`}
                      {index === 2 && `
...
上品で大人っぽい印象に仕上げました🌸`}
              ...
              {index < recommendPosts.length - 1 && <View style={styles.postSeparator} />}
            </View>
          ))}
        </ScrollView>
      </View>
